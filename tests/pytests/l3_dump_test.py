...
def test_unit_test_dump_log_entries():
    """
    Build and run the unit-test, which will create logging dump files.
    Invoke the L3-dump utility and verify the results are as expected.
    ...
    **** Maintenance Warning **** There is some hard-coding of targets built
    ...
    l3_dump_dat = '/tmp/l3.c-unit-test.dat'
    ...
    (nentries, tid_list, loc_list, msg_list, arg1_list, arg2_list) \
        = l3_dump.do_main([L3_DUMP_ARG_LOG_FILE, '/tmp/l3.c-unit-test.dat',
                           L3_DUMP_ARG_BINARY,    binary],
    ...
    # -----------------------------------------------------------------------
    exp_msg_list = [  'log-msg: Args(arg1=1, arg2=2)'
                    , 'log-msg: Args(arg3=3, arg4=4)'
                    , 'log-msg: Args(arg1=10, arg2=20)'
...
def verify_l3_dump_unpack(l3_dump_dat:str,
    ...
    """
    Arguments:
      l3_dump_dat   : L3-generated data file; '/tmp/l3.c-test.dat'
...
def build_exp_loc_msg_list(prog_dir:str, main_file:str) -> (list, list):
    ...
    # `grep -E` seems-to-need space after `-E`, like `-E 'l3_log`
