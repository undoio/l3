...
function test-l3_dump_py-missing-loc_decoder()
{
    ...
    # test-run-C-samples-with-LOC-wo-L3_LOC_ENABLED()
    local test_prog="tests/build/${Build_mode}/bin/use-cases/single-file-C-program"
...
function test-build-and-run-csperf-baseline()
{
    ...
    local server_bin="./tests/build/${Build_mode}/bin/use-cases/svmsg_file_server"
    local client_bin="./tests/build/${Build_mode}/bin/use-cases/svmsg_file_client"
...
function test-build-and-run-spdlog-sample()
{
    ...
    local test_prog="tests/build/${Build_mode}/bin/use-cases/spdlog-Cpp-program"
...
function test-build-and-run-source-location-cpp20-sample()
{
    ...
    local test_prog="tests/build/${Build_mode}/bin/use-cases/source-location-Cpp-program"
